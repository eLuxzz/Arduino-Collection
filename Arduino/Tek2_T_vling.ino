...
int turnTime = 1300;             //amount that the robot will turn once it has backed up
...
void loop()
{
  ...
  if (digitalRead(switchPin) == LOW) { //if the on switch is flipped
    ...
    if (distance < 8) {              //if an object is detected
      //back up and turn
      Serial.print(" ");
      Serial.print("BACK!");
      ...
      else if (currentTurn == 2)
      {
        ...
        {
           Serial.println("Third Turn");
          toTurnRight = 0;
          currentTurn = 4;  
        }
   else if (currentTurn == 4)
        {
           Serial.println("Fourth Turn");
          toTurnRight = 1;
          currentTurn = 5;  
        }
